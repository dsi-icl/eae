...
MinIOStorage.prototype._internalClosure = function (callback, ...args) {
    ...
    let _connect_check = function () {
        return new Promise(function (resolve, reject) {
            ...
            _this._client.listBuckets().then(function (connected){
                resolve(connected);
            }, function (error){
    ...
    let _bucket_check = function () {
        return new Promise(function (resolve, reject) {
            _this._client.bucketExists(_this._bucketName).then(function (exists) {
                if (!exists) {
                    _this._client.makeBucket(_this._bucketName, _this._bucketRegion ?? '').then(function (create_ok){
                        resolve(create_ok);
                    }, function (error){
...
MinIOStorage.prototype.createObject = function (object_data, fileName) {
    ...
    return _this._internalClosure(function () {
        return new Promise(function (resolve, reject) {
            ...
            _this._client.statObject(_this._bucketName, objName).then(function (_unused__stat_ok){
                throw new Error(`File "${objName}" in bucket "${_this._bucketName}" already exists.`);
